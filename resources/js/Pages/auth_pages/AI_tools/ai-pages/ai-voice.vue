<template>
<div class="frame_ai_voice">
    <div class="cards">
        <div class="card" v-for="(tool,index) in $page.props.auth.AiSpeech[0]">
            ...
            <div class="desc_card" v-if="$page.props.auth.user.payment">
                <div v-if="$page.props.auth.user.special_user || $page.props.auth.user_plan[0].title == 'Pro' || $page.props.auth.user_plan[0].title == 'Premium'">
                ...
                <div v-else>
                    <p class="title" @click="need_subscription_popup_fun('Pro')">{{ tool.title }}</p>
                    <p class="description" @click="need_subscription_popup_fun('Pro')">{{ tool.description }}</p>
                </div>
            </div>
