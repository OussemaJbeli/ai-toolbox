    ...
    <AuthenticatedLayout>
        ...
        <div class="chat_tools_template">
            <div class="first_part" :style="{left: open_convertation? '0px':'-310px'}">
                <div class="close_open" @click="open_close()">
                    <i class="fa-solid fa-xmark" v-if="open_convertation"></i>
                    <i class="fa-solid fa-bars-staggered" v-else></i>
                </div>
                <input 
