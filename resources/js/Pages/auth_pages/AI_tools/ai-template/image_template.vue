<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="image_tools_template">
            <div class="first_part">
                ...
                <div class="description">Unleash your creativity with our AI image generator that produces stunning visuals in seconds.</div>
                <div class="input_text">
                    <input type="text" @keyup.enter="sendPrompt()" class="input" v-model="prompt" :placeholder="'Whats your mind ,'+$page.props.auth.user.name+'?'">
                    <div class="button" @click="sendPrompt()">
                        <div class="sp" v-if="!isAssistantTyping">
                        ...
                        <svg class="pl" width="240" height="240" viewBox="0 0 240 240" v-else>
            ...
            <div class="second_part">
                <div class="result" v-if="generatedImagePath || isAssistantTyping">
                    <img :src="generatedImagePath" alt="">
                    <div class="on_generate" v-if="isAssistantTyping">
                ...
                <div class="historiw">
                    ...
                    <div class="images">
                        <div class="card" v-if="generatedImagePath">
                            <img :src="generatedImagePath" alt="">
                            <div class="title">{{ generatedImageTitle }}</div>
                            <div class="managment">
                        ...
                        <div class="card" v-for="image in images">
                            ...
                            <div class="managment">
                                ...
                                <i class="fa-solid fa-eye" @click="openimage_frame(image.image_path,image.title,image.created_at)"></i>
    ...
    methods: {
        checkToken(){
            if(this.Image_tokens[0]){
                this.countToken = this.Image_tokens[0].current_images;

                if(this.$page.props.auth.user.special_user)
                    this.countToken = this.Image_tokens[0].current_images;

                else if(this.$page.props.auth.user.payment)
                    this.curentToken = this.Image_tokens[0].max_image;
        ...
        imageUrl(imageName) {
            const currentURL = import.meta.env.VITE_APP_URL
            return `${currentURL}/${imageName}`;
        },
        ...
        downloadWithAxios(url, title) {
            const imageLink = this.imageUrl(url);
            axios({
                method: 'post',
                url: imageLink,
                ...
                .catch(error => {
                console.error("There was an error download the image:", error);
                });
        },
        ...
        sendPrompt() {
            ...
            axios.post('/ai_tools_template/generateImage', { 
                prompt: this.prompt,
                ...
                .then(response => {
                    ...
                    this.generatedImagePath = response.data.imagePath;
                    this.generatedImageTitle = response.data.imageTitle;
                })
                .catch(error => {
